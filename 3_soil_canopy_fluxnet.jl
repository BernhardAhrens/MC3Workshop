...
# =============================================================================
# 
# In the default canopy tutorial, we demonstrated how to run the canopy model in
# standalone mode using a prescribed soil moisture and ground temperature. 
# ClimaLand can also integrate the canopy model with a prognostic soil model
# and timestep the two components together to simulate an interacting 
# canopy-soil system. This tutorial demonstrates how to set that up.
# 
...
# In the next tutorial, we will interact with the modularity in the parameters 
# and parameterizations by changing these defaults.
...
required_pkgs = ["Dates", "ClimaParams", "ClimaDiagnostics", "DelimitedFiles", "ClimaLand"]
import Pkg
Pkg.Registry.update()
...
# SoilCanopyModel. Here we use the highest level model constructor, which uses 
# default parameters, and parameterizations, for the soil and canopy models.
